...
/*
 * Added fixes by 'Fool Running' of LWJGL forum.
 * 
 * Changed a few lines to make compile
 * Added "new PixelFormat(8,8,8)" to display to make work
 * 
 * Jamie Nicholas
 * www.flyingkakapo.co.nz
 * 18/10/2012
 * 
 */
...
//    GLUquadricObj   *q;                                     // Quadratic For Drawing A Sphere
    ...
    public static void main(String args[]) {
        ...
        Lesson27Fixed l27 = new Lesson27Fixed();
        l27.run(fullscreen);
    }
    ...
    private void createWindow() throws Exception {
        ...
        Display.create(new PixelFormat(8,8,8)); // Added new PixelFormat(8,8,8) to get it working
    }
