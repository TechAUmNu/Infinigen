...
public class MatrixHandler extends Matrix4f {
	...
	public void updateMatrix() {
		...
		Matrix4f.rotate((float) Math.toRadians(angle.z), new Vector3f(0, 0, 1), this, this);
		Matrix4f.rotate((float) Math.toRadians(angle.y), new Vector3f(0, 1, 0), this, this);
		Matrix4f.rotate((float) Math.toRadians(angle.x), new Vector3f(1, 0, 0), this, this);
	}
