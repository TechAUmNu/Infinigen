...
public class VBOTextureDemo {
	...
	public static void main(String[] args) {
		...
		try {
			texture = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/images/uvgrid01.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		FloatBuffer textureData = BufferUtils.createFloatBuffer(amountOfVertices * texSize);
		textureData.put(new float[] { 0f, 1f, 1f, 1f, 0f, 0f, 1f, 0f, 0f, 0f, 1f, 1f, }); // Texture
																							// Coordinate
		textureData.flip();
