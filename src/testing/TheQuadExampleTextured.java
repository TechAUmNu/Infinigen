...
public class TheQuadExampleTextured {
    ...
    private void setupTextures() {
        texIds[0] = this.loadPNGTexture("res/images/uvgrid01.png", GL13.GL_TEXTURE0);
        texIds[1] = this.loadPNGTexture("res/images/uvgrid07.png", GL13.GL_TEXTURE0);
    ...
    private void setupShaders() {       
        ...
        vsId = this.loadShader("src/shaders/testing.vs", GL20.GL_VERTEX_SHADER);
        // Load the fragment shader
        fsId = this.loadShader("src/shaders/testing.fs", GL20.GL_FRAGMENT_SHADER);
